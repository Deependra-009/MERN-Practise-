...
var response = require('loads/node_modules/xhr-response')
  , statuscode = require('loads/node_modules/xhr-status')
  , one = require('loads/node_modules/one-time')
  , fail = require('loads/node_modules/failure');
